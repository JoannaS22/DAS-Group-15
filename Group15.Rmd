...
ggpairs(coffee_nocountry) +
  theme(plot.background = element_rect(
    ...
    size = 1))
```
From the results of the correlation test, only aroma, flavor, and acidity are highly correlated with Qualityclass, while the correlation between category_two_defects, altitiude_mean_meters, harvested, and Qualityclass is very low.
...
Modelname <- c("aroma+flavor+acidity","aroma","flavor","acidity",
              ...
              "aroma*acidity+flavor*acidity","aroma*flavor+acidity*flavor+acidity*aroma","aroma*flavor*acidity")
