...
library(readxl)
######################### 老师发的是dataset15.csv吗
coffee <- read.csv("/Users/sunyazhu/Desktop/University of Glasgow/R program/AllDatasetsR/coffee.csv")
...
coffee.pr <- predict(model9, type="response")
...
p9<- ggplot(perfd, aes(x= x, y=y)) + geom_line() +
